insert into user (jmbg, ime, prezime, password, role, username, adresa, brojtelefona) values ("0306996810013","Sabi","Franjo","$2a$04$X7vevLhbNGjVFp3bO7EjDuSq3.Q9v.PeuUagIFxkw/RKOzXmNsOxi","ADMINISTRATOR","sabi", "Kraljevica Marka 6", "553");
...
insert into user (jmbg, ime, prezime, password, role, username, adresa, brojtelefona) values ("0211996810013","Nikola","Trtic","$2a$04$X7vevLhbNGjVFp3bO7EjDuSq3.Q9v.PeuUagIFxkw/RKOzXmNsOxi","NASTAVNIK","trle", "Zrtava Fasizma 30", "55");
